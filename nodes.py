...
#     @classmethod
#     def INPUT_TYPES(s):
#         return {"required": { "ckpt_name": (folder_paths.get_filename_list("upscale_models"), ),
#                              }}
#     RETURN_TYPES = ("PTH")
#     FUNCTION = "load_upscale_checkpoint"

#     CATEGORY = "loaders"

#     def load_upscale_checkpoint(self, ckpt_name, output_vae=True, output_clip=True):
#         ckpt_path = folder_paths.get_full_path("upscale_models", ckpt_name)
#         out = comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
#         return out[:3]
