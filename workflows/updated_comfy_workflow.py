...
def main():
    ...
    neg_prompt = "cartoon, painting, illustration, (worst quality, low quality, normal quality:2),(deformed iris, deformed pupils, semi-realistic, cgi, 3d, render, sketch, cartoon, drawing, anime, mutated hands and fingers:1.4), (deformed, distorted, disfigured:1.3), poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, disconnected limbs, mutation, mutated, ugly, disgusting, amputation,text,watermark"
    ...
    model_settings_prompt =  '' #'masterpiece, 4k, ray tracing, intricate details, highly-detailed, hyper-realistic, 8k RAW Editorial Photo,film grain ISO 200 faded film, 35mm photo, grainy, vignette, vintage, Kodachrome, Lomography, stained, highly detailed, found footage'
    lora_name = "epiCRealismHelper.safetensors" #copy filename from \models\loras with extension
    ckpt_path = "epicrealism_naturalSinRC1VAE.safetensors" #base model
    output_folder = r'D:\SeeThrough\ComfyUI_windows_portable\ComfyUI\retirement_dataset_fake_sd1.5_04062025' #folder to save generate images to, defaults to output folder in root comfyui
